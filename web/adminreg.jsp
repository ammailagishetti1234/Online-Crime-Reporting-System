<%-- 
    Document   : adminreg
    Created on : Apr 2, 2024, 7:03:38 AM
    Author     : lenovo
--%>
...
<html>
    ...
    <div class="row p-2">
        <div class="col-md-6 offset-md-3">
            <div class="card">
                <div class="card-body">
                    <h4 class="text-center text-success">Admin Registration Page</h4>
...
<form action="adminreg" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="code" id="exampleInputPassword1" required>
  </div>
